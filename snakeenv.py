...
class SnekEnv(gym.Env):
	...
	def step(self, action):
		...
		cv2.waitKey(1)
		self.img = np.zeros((250,250,3),dtype='uint8')
		# Display Apple
		...
		self.total_reward = (((len(self.snake_position) - 3) * 10000) + (125 - dist_to_apple))/100 # default length is 3
